...
public class VotifierPlugin implements Listener {
  ...
  public void onVote(VotifierEvent e) {
    ...
    if (Bukkit.getPlayer(e.getVote().getUsername()) != null) {
      ...
      Bukkit.getPlayer(e.getVote().getUsername()).sendMessage(Survival.getInstance().prefix + " �7Danke das du f�r uns gevotet hast. �8[�e" + e.getVote().getServiceName() + "�8]");
      ...
      Bukkit.getPlayer(e.getVote().getUsername()).getInventory().addItem(ItemManager.build(Material.IRON_NUGGET, "�cM�nze", Arrays.asList("�7�oDu kannst diese M�nzen beim Markt eintauschen.")));
    } else {
