...
public class ChangedExpEvent extends Event {
  ...
  public ChangedExpEvent(final SurvivalPlayer survivalPlayer, final Float oldExp, final Float newExp, final Integer oldLevel, final Integer newLevel) {
    this.survivalPlayer = survivalPlayer;
    this.oldExp = oldExp;
    this.newExp = newExp;
    this.oldLevel = oldLevel;
    this.newLevel = newLevel;
    this.changedLevel = oldLevel == newLevel ? false : true;
  }
