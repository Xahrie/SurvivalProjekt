...
public final class Messages {
  ...
  public static final String ZONE_EXPLAINATION = "§8┃ §eSurvival §7» Klicke mit einem Stock auf die erste Ecke deiner Zone, danach klicke " +
      "auf die gegenüber liegende Ecke.";
  public static final String ZONE_HELP = "§8┃ §eSurvival §7» Zonenhilfe§8:\n§e/zone create §8┃ §7Erstellt eine Zone\n§e/zone search §8┃ " +
      "§7Sucht nach Zonen\n§e/zone add <Spieler> §8┃ §7Fügt einen Spieler auf deine Zone hinzu\n§e/zone remove <Spieler> §8┃ §7Entfernt " +
      "einen Spieler von deiner Zone\n§e/zone delete §8┃ §7Löscht deine Zone";
  public static final String ZONE_HELP_ADMIN = "§c/zone setlength <Spieler> <Anzahl> §8┃ §7Setzt die Max-Länge der Zone des Spielers §c/zone " +
      "info <Spieler> §8┃ §7Zeigt Informationen über den Spieler an§c/zone info §8┃ §7Zeigt Informationen über die Zone in der du stehst an";
